...
export function CommandPalette({ isOpen, onClose }: CommandPaletteProps) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Search Bar Input */}
        <div className="flex items-center gap-3 px-4 py-3.5 border-b border-stone-800 bg-stone-950/80">
          ...
          <input
            ...
            autoFocus
            className="w-full bg-transparent text-sm text-stone-100 placeholder-stone-500 focus:outline-none font-mono"
          />
          <kbd className="hidden sm:inline-block px-2 py-0.5 text-[10px] font-mono text-stone-400 bg-stone-800 rounded border border-stone-700">
            ESC
          </kbd>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    <Icon className={`w-4 h-4 ${isSelected ? "text-rose-400" : "text-stone-400"}`} />
        ...
        {/* Footer shortcuts */}
        <div className="px-4 py-2 bg-stone-950/80 border-t border-stone-800 flex items-center justify-between text-[10px] font-mono text-stone-500">
          <div className="flex items-center gap-3">
            <span><kbd className="px-1 py-0.5 bg-stone-800 rounded">↑↓</kbd> Navigate</span>
            <span><kbd className="px-1 py-0.5 bg-stone-800 rounded">↵</kbd> Select</span>
          </div>
          <div>Developer Command Shell</div>
        </div>
      </div>
    </div>
  );

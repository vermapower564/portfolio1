          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="flex items-center gap-4 flex-wrap">
              ...
              <div className="space-y-1.5">
                ...
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-sky-500/10 dark:bg-sky-500/15 border border-sky-500/30 text-sky-600 dark:text-sky-400 font-mono text-xs font-bold tracking-wider">
